...
int main(){
    ...
    for (int iEnt=0; iEnt < n4Entries; iEnt++) {
        ...
        std::cout << "booleans deltaklongmass " << deltaklongmass << "\n";
        ...
        if (xyCOEbool && g4xyCOE<g4xyCOEvalue) xycoe = true;
        if (Pi0RecZbool) {
            for (int l=0; l<2; l++){
    ...
    for (int i=0; i<6; i++){
        ...
        c[i]->SaveAs(TString::Format("KaonFluxG4/%s_klongflux.eps",name[i].Data()));
